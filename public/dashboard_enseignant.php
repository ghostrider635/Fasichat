<?php require __DIR__ . '/_bootstrap.php'; requireDashboardRoles(['Enseignant', 'Assistant']); ?>
<!DOCTYPE html>
<html lang="fr">
<head>
<meta charset="UTF-8">
...
<div class="sidebar">
  ...
  <div class="sidebar-profile">
    ...
    <div class="profile-actions"><a href="index.php?action=logout" class="icon-btn">🚪</a></div>
  </div>
</div>
